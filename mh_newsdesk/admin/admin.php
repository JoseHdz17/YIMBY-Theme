		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p><strong><?php _e('Important Links:', 'mh-newsdesk'); ?></strong>
					<a href="http://www.mhthemes.com/themes/mh/newsdesk/" target="_blank"><?php _e('Theme Info Page', 'mh-newsdesk'); ?></a>
					<a href="http://www.mhthemes.com/support/" target="_blank"><?php _e('Support Center', 'mh-newsdesk'); ?></a>
					<a href="https://www.facebook.com/MHthemes" target="_blank"><?php _e('Facebook', 'mh-newsdesk'); ?></a>
					<a href="https://twitter.com/MHthemes" target="_blank"><?php _e('Twitter', 'mh-newsdesk'); ?></a>
					<a href="https://www.youtube.com/user/MHthemesEN" target="_blank"><?php _e('YouTube', 'mh-newsdesk'); ?></a>
				</p>
			</div>
			<hr>
				...
				<div class="row clearfix">
					<div class="col-1-2">
						<div class="section">
							...
							<p>
								<a href="http://www.mhthemes.com/support/documentation-mh-newsdesk/" target="_blank" class="button button-secondary"><?php _e('Visit Documentation', 'mh-newsdesk'); ?></a>
							</p>
						</div>
						<div class="section">
						...
						<div class="section">
							...
							<p>
								<a href="http://www.mhthemes.com/members/login/" target="_blank" class="button button-secondary"><?php _e('Login to MH Themes account', 'mh-newsdesk'); ?></a>
							</p>
						</div>
					</div>
					<div class="col-1-2">
